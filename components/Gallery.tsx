            ...
            <div className="bg-white rounded-2xl overflow-hidden">
                <div className={`flex items-center p-3 space-x-3`} style={{backgroundColor: platformColor}}>
                    <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
                        <img src="/images/Autonest.png" alt="Autonest Logo" className="h-7 w-7 rounded-full object-cover bg-white p-0.5" />
                    </div>
                    <div>
        ...
        <section className="py-20 bg-white">
            <div className="container mx-auto px-6">
                <div className="text-center mb-12 fade-in-section">
                    ...
                    <p className="text-lg text-gray-600 mt-4 max-w-3xl mx-auto">Recibe alertas y comunicados a través de tus plataformas de mensajería favoritas.</p>
                </div>
                <div className="grid md:grid-cols-2 gap-12 lg:gap-16 fade-in-section">
                    <PhoneMockup 
                        platform="whatsapp"
                        message="Hola! Detectamos que la presión de tu neumático delantero derecho está baja. Te recomendamos revisarla en la próxima estación de servicio."
                        platformColor="#25D366"
                    />
                    <PhoneMockup 
                        platform="telegram"
                        message="Recordatorio de servicio: Tu Toyota Corolla necesita su cambio de aceite en los próximos 500km. ¿Quieres que te agendemos una cita?"
