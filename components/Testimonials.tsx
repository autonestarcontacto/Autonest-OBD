        ...
        <section id="testimonios" className="py-20 bg-white">
            <div className="container mx-auto px-6">
                <div className="text-center mb-12 fade-in-section">
                    <h2 className="text-4xl font-bold text-autonest-dark">Lo que dicen nuestros conductores</h2>
                    <p className="text-lg text-gray-600 mt-4 max-w-3xl mx-auto">La confianza y tranquilidad de nuestros usuarios es nuestra mayor recompensa.</p>
                </div>
